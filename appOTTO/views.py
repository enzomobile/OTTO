...
FASES = {
1: {"fase": "Fase 1", "titulo": "Bom dia Otto", "img": "appOTTO/img/cenarios/lv1.png", "descricao": "Dê bom dia para o Otto! Use o botão de imprimir e junte-o com o de texto para aparecer a seguinte mensagem 'Bom dia Otto!' "},
...
8: {"fase": "Fase 8", "titulo": "OTTO treinando", "img": "appOTTO/img/cenarios/lv8.png", "descricao": "OTTO começou a malhar, ajude ele a contar suas repetições! Comece inicializando o contador como 0 e depois, para verificar se o OTTO está treinando, crie a variável treino como verdadeiro. Agora vamos verificar o treino do OTTO: se treino for verdadeiro, chamar a função 'treinar'. Para isso temos que criá-la. Dentro da função treinar, defina que o contador seja ele mesmo somado com 1 e logo após imprima uma mensagem juntando o texto 'Exercícios feitos:' + a variável contador."},
9: {"fase": "Fase 9", "titulo": "Passeio do OTTO", "img": "appOTTO/img/cenarios/lv9.png", "descricao": "OTTO foi passear e anotou em uma lista seus gastos, ajude ele a anotar e analisar os custos! Primeiro OTTO criou uma lista vazia e colocou em uma variável chamada 'contas' e depois ele adicionou todos os seus gastos. Começando pelo sorvete que custou '5' moedas, seu segundo gasto foi comprando uma bola que custou '20' moedas e o terceiro e último foi um lanche por '15' moedas. Agora imprima a variável contas mostrando sua lista de gastos."},
10: {"fase": "Fase 10", "titulo": "Apresentação Final", "img": "appOTTO/img/cenarios/lv10.png", "descricao": "OTTO vai fazer sua apresentação! para que a sua apresentação é nescessario luzes, musica e plateia defina elas como variavies verdadeiras, logo quando a apresentação começa o ritmo em 1 e se as luzes 'E' musica 'E' plateia existirem faça que se repita enqaunto o ritmo for ou igual a 3, imprima a mensagem : 'Tocando ritmo ' + a variavel plateia e após isso some a variavel ritmo + 1 e após o ritmo chegar ao ideal mostra a mensagem 'Show completo! Todos aplaudem!' e se as condições não estivere, corretas aparecer a mensagem 'Algo deu errado! O show não pode começar.'."},
}
