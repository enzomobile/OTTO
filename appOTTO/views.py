...
FASES = {
    ...
    2: {"fase": "Fase 2", "titulo": "Fruta favorita", "descricao": "Ajude Otto a escolher a fruta certa, sua fruta favorita é Banana! Crie a variável 'fruta' e coloque como seu valor de texto 'Banana', depois verifique se a fruta é mesma 'Banana' use o botão 'SE' e compare se fruta = 'Banana' e se for imprima 'Fruta certa' e se não 'Fruta errada'."},
